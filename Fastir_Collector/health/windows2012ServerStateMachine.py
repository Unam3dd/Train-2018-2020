...
class Windows2012ServerStateMachine(_Statemachine):
    ...
    def csv_hash_running_proccess(self):
        super(Windows2012ServerStateMachine, self)._csv_hash_running_process(self._list_running())
    ...
    def json_hash_running_proccess(self):
        super(Windows2012ServerStateMachine, self)._json_hash_running_process(self._list_running())
